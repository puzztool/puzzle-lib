...
class NavalFlags {
  public static readonly instance: NavalFlags = new NavalFlags();

  private readonly _entries: CharacterImage[] = [
    // tslint:disable:max-line-length (SVG images are messy)
    new CharacterImage(
      'A',
      new InlineSvg(`<path d="M 18,18 H 162 L 126,90 L 162,162 H 18 z" fill="#000094"/>
    ...
    new CharacterImage(
      'B',
      new InlineSvg('<path d="M 18,18 H 162 L 126,90 L 162,162 H 18 z" fill="#f00" stroke="#000" stroke-width="3.75" stroke-linejoin="round"/>',
      180, 180)),
    new CharacterImage(
      'C',
      new InlineSvg(`<rect x="18" y="18" width="144" height="144" fill="#000094"/>
    ...
    new CharacterImage(
      'D',
      new InlineSvg(`<rect x="18" y="18" width="144" height="144" fill="#fc0"/>
    ...
    new CharacterImage(
      'F',
      new InlineSvg(`<rect x="18" y="18" width="144" height="144" fill="#fff"/>
      <path d="M 90,18 l 72,72 l -72,72 l -72,-72 z" fill="#f00"/>
      <path d="M 18,18 H 162 V 162 H 18 z" fill="none" stroke="#000" stroke-width="3.75" stroke-linejoin="round"/>`,
      180, 180)),
    new CharacterImage(
      'G',
      new InlineSvg(`<path fill="#000094" d="m18,18h144v144H18"/>
    ...
    new CharacterImage(
      'H',
      new InlineSvg(`<rect x="18" y="18" width="144" height="144" fill="#f00"/>
      <rect x="18" y="18" width="72" height="144" fill="#fff"/>
      <path d="M 18,18 H 162 V 162 H 18 z" fill="none" stroke="#000" stroke-width="3.75" stroke-linejoin="round"/>`,
      180, 180)),
    new CharacterImage(
    ...
    new CharacterImage(
      'L',
      new InlineSvg(`<rect x="16" y="16" width="148" height="148" rx="2"/>
      <path fill="#FC0" d="m20,20h70v140h70V90H20"/>`,
      180, 180)),
    new CharacterImage(
      'M',
      new InlineSvg(`<clipPath id="c">
    ...
    new CharacterImage(
      'U',
      new InlineSvg(`<rect x="18" y="18" width="144" height="144" fill="#ffffff"/>
    ...
    new CharacterImage(
      'Y',
      new InlineSvg(`<clipPath id="c"><path d="m18,18h144v144H18"/></clipPath>
  ...
  public get entries(): CharacterImage[] {
    return this._entries;
  }

  public lookup(letter: string): CharacterImage | null {
